  ...
  - **Проверка взаимодействия с БД**
    - Карта 1 (Активная)
      - Обычная покупка
        ...
        1. Заполняем все поля валидными данными
        1. Нажимаем кнопку подтверждения
        1. Проверяем, что статус новой записи в БД, в таблице payment_entity соотвтествует статусу карты "APPROVED"
      - Покупка в кредит 
        1. Открываем сервис
        1. Выбираем покупку в кредит
        1. Заполняем все поля валидными данными
        1. Нажимаем кнопку подтверждения
        1. Проверяем, что статус новой записи в БД, в таблице credit_request_entity соотвтествует статусу карты "APPROVED"
    ...
    - Карта 2 (Не активная)
       - Обычная покупка
        ...
        1. Заполняем все поля валидными данными
        1. Нажимаем кнопку подтверждения
        1. Проверяем, что статус новой записи в БД, в таблице payment_entity соотвтествует статусу карты "DECLINED"
       - Покупка в кредит 
        1. Открываем сервис
        1. Выбираем покупку в кредит
        1. Заполняем все поля валидными данными
        1. Нажимаем кнопку подтверждения
        1. Проверяем, что статус новой записи в БД, в таблице credit_request_entity соотвтествует статусу карты "DECLINED"
